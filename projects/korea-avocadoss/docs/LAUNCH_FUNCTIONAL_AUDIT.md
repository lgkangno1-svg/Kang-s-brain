...
4. Continue Explore freshness/geospatial hardening after full-route map handoff. Food provenance now automatically degrades to verify-only after 30 days; next Explore gaps are source-refresh operations, walking/geospatial calibration and closure exceptions.
