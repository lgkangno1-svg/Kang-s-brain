...
3. Continue Hanbok locale-native catalog descriptions and edge-case/device QA.
...
5. Continue My Korea Look locale-native result/catalog content; all active free-preview input dimensions are already wired through deterministic ranking and persistence/export.
