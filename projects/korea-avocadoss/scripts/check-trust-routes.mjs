...
assert.doesNotMatch(layout,/<span>\{shell\.(about|contact|privacy|terms)\}<\/span>/,'Footer trust labels must be actionable links');
...
console.log('Trust-route contract passed: real footer destinations, honest pre-launch legal copy, canonical/hreflang and sitemap coverage are present.');
