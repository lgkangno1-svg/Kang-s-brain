...
const ui=fs.readFileSync(path.join(root,'src/features/looks/style-consultation-v3.tsx'),'utf8');
...
for(const marker of ['StyleConsultationV3','visitDate','setDestination','setPalette','setMood','setComfort','setCoverage','kc-my-korea-look-plan-v2','localStorage.setItem','navigator.clipboard','URL.createObjectURL','role="alert"','role="status"']){
...
if(!page.includes('StyleConsultationV3'))throw new Error('live style route is not wired to the full input experience');
