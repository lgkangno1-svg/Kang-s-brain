...
const HOME_COPY: Record<P0Locale, HomeCopy> = {
  en: {
    ...
    prelaunchBadge: 'FREE BETA · PAID CHECKOUT OFF',
    prelaunchTitle: 'My Korea Look — Personalized Styling & Palace Photo Guidebook',
    prelaunchText: 'The free beta is open: try the style preview, Personal Color, Hanbok matching, palace planning and culture tools now. Real-money checkout stays disabled while payment-grade ownership and recovery are completed.',
    previewAction: 'Start the Free Beta',
  ...
  'zh-CN': {
    ...
    prelaunchBadge: '免费测试版 · 暂不开放付款',
    prelaunchTitle: 'My Korea Look — 个性化韩服与宫殿拍照指南',
    prelaunchText: '免费测试版现已开放：可以体验造型、个人色彩、韩服匹配、宫殿行程和韩国文化工具。真实付款会在账户归属和支付恢复流程完成后再开放。',
    previewAction: '开始免费测试版',
    sampleAction: '查看示例',
  },
  ja: {
    ...
    prelaunchBadge: '無料ベータ · 有料決済はオフ',
    prelaunchTitle: 'My Korea Look — パーソナル韓服＆宮殿フォトガイド',
    prelaunchText: '無料ベータを利用できます。スタイル、パーソナルカラー、韓服マッチ、宮殿プラン、Kカルチャー機能を試せます。実決済は所有・復旧基盤が完成するまで無効です。',
    previewAction: '無料ベータを始める',
  ...
  'zh-TW': {
    ...
    prelaunchBadge: '免費測試版 · 暫不開放付款',
    prelaunchTitle: 'My Korea Look — 個人化韓服與宮殿拍照指南',
    prelaunchText: '免費測試版現已開放：可體驗造型、個人色彩、韓服配對、宮殿行程與韓國文化工具。真實付款會在帳戶歸屬與付款復原流程完成後再開放。',
    previewAction: '開始免費測試版',
    sampleAction: '查看範例',
  },
  vi: {
    ...
    prelaunchBadge: 'BETA MIỄN PHÍ · CHƯA MỞ THANH TOÁN',
    prelaunchTitle: 'My Korea Look — Cẩm nang Hanbok và chụp ảnh cung điện cá nhân hóa',
    prelaunchText: 'Beta miễn phí đã mở: hãy thử phong cách, Personal Color, ghép Hanbok, lập lộ trình cung điện và các công cụ văn hóa. Thanh toán thật vẫn tắt cho đến khi hoàn tất quyền sở hữu và phục hồi thanh toán.',
    previewAction: 'Bắt đầu beta miễn phí',
  ...
  th: {
    ...
    prelaunchBadge: 'เบต้าฟรี · ปิดการชำระเงินจริง',
    prelaunchTitle: 'My Korea Look — คู่มือฮันบกและถ่ายภาพพระราชวังเฉพาะคุณ',
    prelaunchText: 'เปิดเบต้าฟรีแล้ว: ทดลองสไตล์ Personal Color การจับคู่ฮันบก การวางแผนพระราชวัง และเครื่องมือวัฒนธรรมได้ทันที ระบบชำระเงินจริงยังปิดจนกว่าระบบสิทธิ์และการกู้คืนการชำระเงินจะพร้อม',
    previewAction: 'เริ่มเบต้าฟรี',
