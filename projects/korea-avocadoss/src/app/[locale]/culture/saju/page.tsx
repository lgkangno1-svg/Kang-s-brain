...
export default async function SajuPage({params}:PageProps){const {locale}=await params;setRequestLocale(locale);return <main><SajuCompleteExperience locale={locale}/></main>;}
