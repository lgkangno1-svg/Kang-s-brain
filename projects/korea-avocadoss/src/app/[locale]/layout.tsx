...
type ShellCopy={explore:string;style:string;color:string;hanbok:string;culture:string;quickHelp:string;about:string;contact:string;privacy:string;terms:string;beta:string};
const SHELL_COPY:Record<P0Locale,ShellCopy>={
 en:{explore:'EXPLORE',style:'MY LOOK',color:'PERSONAL COLOR',hanbok:'HANBOK',culture:'K-CULTURE',quickHelp:'QUICK HELP',about:'About Us',contact:'Contact',privacy:'Privacy Policy',terms:'Terms of Service',beta:'BETA'},
 'zh-CN':{explore:'探索',style:'定制造型',color:'个人色彩',hanbok:'韩服',culture:'韩国文化',quickHelp:'快速帮助',about:'关于我们',contact:'联系我们',privacy:'隐私政策',terms:'服务条款',beta:'测试版'},
 ja:{explore:'探す',style:'マイルック',color:'パーソナルカラー',hanbok:'韓服',culture:'Kカルチャー',quickHelp:'クイックヘルプ',about:'私たちについて',contact:'お問い合わせ',privacy:'プライバシーポリシー',terms:'利用規約',beta:'ベータ'},
 'zh-TW':{explore:'探索',style:'客製造型',color:'個人色彩',hanbok:'韓服',culture:'韓國文化',quickHelp:'快速幫助',about:'關於我們',contact:'聯絡我們',privacy:'隱私政策',terms:'服務條款',beta:'測試版'},
 vi:{explore:'KHÁM PHÁ',style:'PHONG CÁCH',color:'MÀU CÁ NHÂN',hanbok:'HANBOK',culture:'K-CULTURE',quickHelp:'TRỢ GIÚP NHANH',about:'Về chúng tôi',contact:'Liên hệ',privacy:'Chính sách riêng tư',terms:'Điều khoản dịch vụ',beta:'BETA'},
 th:{explore:'สำรวจ',style:'สไตล์ของฉัน',color:'เพอร์ซันนัลคัลเลอร์',hanbok:'ฮันบก',culture:'K-CULTURE',quickHelp:'ช่วยเหลือด่วน',about:'เกี่ยวกับเรา',contact:'ติดต่อ',privacy:'นโยบายความเป็นส่วนตัว',terms:'ข้อกำหนดการใช้บริการ',beta:'เบต้า'},
};
