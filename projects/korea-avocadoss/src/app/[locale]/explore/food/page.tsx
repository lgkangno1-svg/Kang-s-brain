...
export default async function FoodPage({params}:Props){const {locale}=await params;setRequestLocale(locale);const places=await getGyeongbokgungFoodPlaces();return <main><FoodFinder locale={locale} places={places}/></main>}
