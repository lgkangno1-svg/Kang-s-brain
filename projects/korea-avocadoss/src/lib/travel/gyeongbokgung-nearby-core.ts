...
export const NEARBY_WALKING_LEGS:readonly NearbyWalkingLeg[]=[
 ...
 {fromId:'gwanghwamun',toId:'insadong',minutes:15,sourceUrl:'https://www.rome2rio.com/s/Gwanghwamun-Square/Insadong',checkedAt:'2026-09-11',confidence:'medium',note:'Gwanghwamun Square to Insadong is currently listed at about 15 minutes on foot. This direct leg is used when the optional information-center stop is closed or omitted.'},
