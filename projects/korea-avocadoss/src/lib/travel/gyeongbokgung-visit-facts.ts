...
function parseIsoDate(date:string){
 ...
 if(parsed.getUTCFullYear()!==year||parsed.getUTCMonth()!==month-1||parsed.getUTCDate()!==day)throw new RangeError('Visit date is invalid.');
...
export function gyeongbokgungVisitFacts(date:string):GyeongbokgungVisitFacts{
 ...
 if(month===1||month===2||month===11||month===12)return{open:'09:00',close:'17:00',lastAdmission:'16:00',regularTuesdayClosure,verificationRequired:regularTuesdayClosure};
 if(month>=6&&month<=8)return{open:'09:00',close:'18:30',lastAdmission:'17:30',regularTuesdayClosure,verificationRequired:regularTuesdayClosure};
